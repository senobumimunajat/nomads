            ...
            <div class="card card-details">
              ...
              <div class="gallery">
                <div class="xzoom-container">
                  <img src="{{ url('frontend/images/pic_featured.jpg')}}" class="xzoom" id="xzoom-default" xoriginal="{{ url('frontend/images/pic_featured.jpg')}}">
                </div>
                <div class="xzoom-thumbs">
                  <a href="{{ url('frontend/images/pic_featured.jpg')}}">
                    <img src="{{ url('frontend/images/pic_featured.jpg')}}" class="xzoom-gallery" width="128" xpreview="{{ url('frontend/images/pic_featured.jpg')}}">
                  </a>
                  <a href="{{ url('frontend/images/pic_featured.jpg')}}">
                    <img src="{{ url('frontend/images/pic_featured.jpg')}}" class="xzoom-gallery" width="128" xpreview="{{ url('frontend/images/pic_featured.jpg')}}">
                  </a>
                  ...
                  <a href="{{ url('frontend/images/pic_featured.jpg')}}">
                    <img src="frontend/images/pic_featured.jpg" class="xzoom-gallery" width="128" xpreview="{{ url('frontend/images/pic_featured.jpg')}}">
                  </a>
                </div>
              </div>
              ...
              <div class="features row">
                <div class="col-md-4">
                  <img src="{{ url('frontend/images/ic_event.png')}}" alt="feature-image" class="features-image">
                ...
                <div class="col-md-4 border-left">
                  <div class="description">
                    <img src="{{ url('frontend/images/ic_language.png')}}" alt="feature-image" class="features-image">
                    <div class="description">
                      <h3>Language</h3>
                ...
                <div class="col-md-4 border-left">
                  <div class="description">
                    <img src="{{ url('frontend/images/ic_foods.png')}}" alt="feature-image" class="features-image">
                    <div class="description">
                      <h3>Foods</h3>
                      <p>Local Foods</p>
                    </div>
          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <div class="members my-2">
                <img src="{{ url('/frontend/images/member.png')}}" alt="" class="member-image mr-1">
